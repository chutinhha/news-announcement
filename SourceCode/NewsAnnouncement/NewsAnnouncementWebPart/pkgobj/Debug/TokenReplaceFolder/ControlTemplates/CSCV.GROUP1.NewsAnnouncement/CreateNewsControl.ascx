...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CreateNewsControl.ascx.cs" Inherits="NewsAnnouncementWebPart.ControlTemplates.CSCV.GROUP1.NewsAnnouncement.CreateNewsControl" %>
<style type="text/css">
    .style1
    {
        width: 122px;
